    ...
    return (
      <div className="flex items-center justify-center py-12">
        <div className="text-center">
          <Loader2 className="h-8 w-8 animate-spin text-segal-blue mx-auto mb-4" />
          <p className="text-segal-dark/60">Cargando dashboard...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2">
        ...
        <Card className="border-segal-turquoise/10">
          <CardHeader>
            <CardTitle className="text-segal-dark">Distribución de Prospectos por Flujo</CardTitle>
