        ...
        <div className="space-y-6 p-6">
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <span className="text-2xl font-bold text-segal-blue">{progressPercentage}%</span>
            </div>
            ...
            <div className="text-sm text-segal-dark/60">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div className="bg-segal-blue/5 rounded-lg p-4 border border-segal-blue/10">
              <div className="flex items-center gap-2 mb-1">
                ...
                <p className="text-xs text-segal-dark/60 font-medium">Total</p>
              </div>
              <p className="text-2xl font-bold text-segal-dark">{stats.total_prospectos}</p>
            </div>
            ...
            <div className="bg-green-50 rounded-lg p-4 border border-green-200">
              ...
              <p className="text-2xl font-bold text-green-700">{stats.total_enviados}</p>
            </div>
            ...
            <div className="bg-red-50 rounded-lg p-4 border border-red-200">
              ...
              <p className="text-2xl font-bold text-red-700">{stats.total_fallidos}</p>
            </div>
            ...
            <div className="bg-yellow-50 rounded-lg p-4 border border-yellow-200">
              ...
              <p className="text-2xl font-bold text-yellow-700">{stats.total_pendientes}</p>
            </div>
          </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="bg-white border border-segal-blue/10 rounded-lg p-4 space-y-3">
                <div className="flex items-center gap-2">
                  ...
                  <h4 className="font-semibold text-segal-dark">Email</h4>
                </div>

                <div className="space-y-2 text-sm">
                  <div className="flex justify-between">
                    <span className="text-segal-dark/60">Enviados</span>
                    <span className="font-semibold text-green-600">{stats.email_enviados}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-segal-dark/60">Fallidos</span>
                    <span className="font-semibold text-red-600">{stats.email_fallidos}</span>
                  </div>
                  <div className="pt-2 border-t border-segal-blue/10">
                    <div className="flex justify-between">
                      <span className="text-segal-dark/60">Total</span>
              ...
              <div className="bg-white border border-segal-blue/10 rounded-lg p-4 space-y-3">
                <div className="flex items-center gap-2">
                  ...
                  <h4 className="font-semibold text-segal-dark">SMS</h4>
                </div>

                <div className="space-y-2 text-sm">
                  <div className="flex justify-between">
                    <span className="text-segal-dark/60">Enviados</span>
                    <span className="font-semibold text-green-600">{stats.sms_enviados}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-segal-dark/60">Fallidos</span>
                    <span className="font-semibold text-red-600">{stats.sms_fallidos}</span>
                  </div>
                  <div className="pt-2 border-t border-segal-blue/10">
                    <div className="flex justify-between">
                      <span className="text-segal-dark/60">Total</span>
          ...
          <div className="bg-segal-blue/5 rounded-lg p-4 border border-segal-blue/10 space-y-2">
            <div className="flex justify-between text-sm">
              <span className="text-segal-dark/60">Inicio:</span>
            ...
            {execution.fecha_fin && (
              <div className="flex justify-between text-sm">
                <span className="text-segal-dark/60">Fin:</span>
                <span className="font-medium text-segal-dark">
          ...
          {/* Botones de control */}
          <div className="flex gap-3 pt-4 border-t border-segal-blue/10">
            <Button
              variant="outline"
              onClick={() => setAutoRefresh(!autoRefresh)}
              className="flex-1 border-segal-blue/20 text-segal-blue hover:bg-segal-blue/5"
            >
