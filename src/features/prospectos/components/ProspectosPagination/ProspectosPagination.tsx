/**
 * Componente de paginación de prospectos
 * Navegación entre páginas con números seleccionables y rango inteligente
 */

import { ChevronLeft, ChevronRight } from 'lucide-react'
import { Button } from '@/components/ui/button'
import type { ProspectosPaginationProps } from '../../types/prospectos'

export function ProspectosPagination({
  currentPage,
  totalPages,
  onPageChange,
}: ProspectosPaginationProps) {
